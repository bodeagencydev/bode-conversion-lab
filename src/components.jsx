...
/* ── BRAND ICON using favicon service ── */
        ...
        {doubled.map((t, i) => (
          <a key={i}
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                {t.storeLogo ? (
                  ...
                  <div style={{ width: 28, height: 28, borderRadius: 6, background: "rgba(0,255,136,.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, color: G, flexShrink: 0 }}>{t.init}</div>
                )}
                <div>
              ...
              <div style={{ background: "rgba(0,255,136,.1)", border: ".5px solid rgba(0,255,136,.25)", borderRadius: 100, padding: "3px 10px", fontSize: 11, color: G, fontWeight: 600, whiteSpace: "nowrap", marginLeft: 8 }}>{t.result}</div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              {t.storeUrl && <span style={{ fontSize: 11, color: G, fontWeight: 500 }}>Visit store →</span>}
            </div>
          </a>
        ))}
      </div>
