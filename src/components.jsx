...
export const Heading = ({ children, style }) => (
  <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, marginBottom: "1.5rem", ...style }}>
    {children}
  </h2>
);

export const GradText = ({ children }) => (
  <span style={{ background: "linear-gradient(135deg,#00ff88,#00cc6a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
    {children}
  </span>
);
...
export function WhatsAppButton() {
  return (
    <a href={`https://wa.me/19454076473?text=${encodeURIComponent("Hi! I'm interested in growth.")}`} target="_blank" rel="noopener noreferrer" style={{ position: "fixed", bottom: 24, right: 24, zIndex: 9999, width: 56, height: 56, borderRadius: "50%", background: "#25D366", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
...
export const PartnerCard = () => <div />;
export const SectionLabel = () => <div />;