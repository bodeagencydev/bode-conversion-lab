...
export const CASE_STUDIES = [
  {
    ...
    platform:"Shopify",
    adSpend:"$3,000/mo",
    beforeImg: "/proof/marcus-before.png",
    afterImg:  "/proof/marcus-after.png",
    proofCaption: "Shopify Analytics — same traffic, 31× more revenue",
  ...
  },
  {
    ...
    adSpend:"$2,500/mo",
    beforeImg: "/proof/priya-before.png",
    afterImg:  "/proof/priya-after.png",
    proofCaption: "WooCommerce + Google Ads — CVR jump from 1.1% to 4.8%",
  ...
  },
  {
    ...
    platform:"Shopify",
    adSpend:"$5,000/mo",
    beforeImg: "/proof/tunde-before.png",
    afterImg:  "/proof/tunde-after.png",
    proofCaption: "Meta Ads Manager — ROAS from 0.9x to 4.3x in 60 days",
