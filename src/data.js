...
/* ── CREDIBILITY BADGES ── */
export const BADGES = [
  { icon: "🏆", title: "Top 3% Global", sub: "E-commerce Agencies 2024", color: "#FFD700" },
  { icon: "✅", title: "Meta Certified",  sub: "Official Business Partner",  color: "#0081FB" },
  { icon: "✅", title: "Google Partner",  sub: "Certified Ads Partner",      color: "#4285F4" },
  { icon: "⚡", title: "Shopify Expert",  sub: "Vetted Shopify Partner",      color: "#96BF48" },
  { icon: "🔒", title: "Klaviyo Master",  sub: "Platinum Email Partner",      color: "#FFD700" },
];
