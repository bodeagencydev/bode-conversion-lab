...
export const CASE_STUDIES = [
  {
    id:"marcus-fitness", client:"Marcus T.", category:"Fitness & Supplements", headline:"From $1,200/mo to $38,000/mo in 90 days",
    summary:"A Shopify fitness brand with great products but a broken funnel. We rebuilt the entire system from scratch.",
    result1:{label:"Revenue",before:"$1,200/mo",after:"$38,000/mo"}, result2:{label:"ROAS",before:"0.8x",after:"6.2x"}, result3:{label:"CVR",before:"0.6%",after:"3.8%"},
    tags:["Shopify","Meta Ads","CRO"],
    story:[{heading:"The problem",body:"Marcus had a great product but was spending $3,000/month on Meta ads and generating less than $1,200 in revenue."},{heading:"The diagnosis",body:"Within 48 hours of our audit, we found the core issue: his product page loaded in 7.2 seconds on mobile and his checkout had 6 unnecessary steps."},{heading:"What we built",body:"We rebuilt his product page cutting load time to 1.4 seconds, reduced checkout to 2 steps, and restructured his Meta campaigns."},{heading:"The result",body:"Month 3: 6.2x ROAS with revenue at $38,000/month. Same ad budget. Same product. Different system."}],
  },
  {
    id:"priya-beauty", client:"Priya S.", category:"Beauty & Skincare", headline:"Checkout friction was killing 40% of sales",
    summary:"A DTC beauty brand with strong traffic but terrible conversion. One audit changed everything.",
    result1:{label:"CVR",before:"1.1%",after:"4.8%"}, result2:{label:"CPA",before:"$68",after:"$19"}, result3:{label:"Revenue",before:"$4k/mo",after:"$22k/mo"},
    tags:["WooCommerce","Google Ads","Email"],
    story:[{heading:"The problem",body:"Priya's skincare brand was getting 15,000 monthly visitors but converting at just 1.1%."},{heading:"The diagnosis",body:"Our audit revealed 11 friction points. Her checkout required account creation before purchase, killing 38% of buyers."},{heading:"What we built",body:"We enabled guest checkout, redesigned product pages, and built a post-purchase email sequence."},{heading:"The result",body:"Conversion rate jumped from 1.1% to 4.8% in 30 days. Revenue went from $4k to $22k/month."}],
  },
  {
    id:"tunde-fashion", client:"Tunde N.", category:"Fashion & Apparel", headline:"Every dollar spent on ads now returns four",
    summary:"A fashion brand burning $5k/month on ads with almost no return. We found the leak in 3 days.",
    result1:{label:"ROAS",before:"0.9x",after:"4.3x"}, result2:{label:"Revenue",before:"$3k/mo",after:"$41k/mo"}, result3:{label:"Ad Spend",before:"$5k/mo",after:"$5k/mo"},
    tags:["Shopify","TikTok Ads","Meta Ads"],
    story:[{heading:"The problem",body:"Tunde's fashion brand had everything going for it but his paid ads were hemorrhaging money."},{heading:"The diagnosis",body:"His TikTok ads were elegant — perfect for Instagram, completely wrong for TikTok's raw culture."},{heading:"What we built",body:"We created raw behind-the-scenes TikTok content and rebuilt Meta retargeting to target product page visitors."},{heading:"The result",body:"Same $5,000 ad budget. ROAS went from 0.9x to 4.3x. Revenue grew from $3k to $41k/month."}],
  },
];

export const BLOG_POSTS = [
  { id:"why-your-roas-is-lying", title:"Why Your ROAS Is Lying to You (And What to Track Instead)", category:"Ad Strategy", date:"April 15, 2025", readTime:"6 min read", excerpt:"Most store owners obsess over ROAS. But ROAS alone is one of the most misleading metrics in e-commerce.", content:[{heading:"The ROAS trap",body:"A 4x ROAS sounds great. But after product cost, fulfillment, returns, and payment processing — you might be barely breaking even."},{heading:"What to track instead",body:"Track MER (total revenue divided by total ad spend), nCAC, and LTV:CAC ratio. These tell you if your business is actually healthy."},{heading:"The bottom line",body:"Stores that scale past $100k/month obsess over contribution margin and LTV — not ROAS."}] },
  { id:"5-checkout-fixes", title:"5 Checkout Fixes That Doubled Our Clients' Conversion Rates", category:"CRO", date:"March 28, 2025", readTime:"8 min read", excerpt:"After auditing 40+ e-commerce stores, we found the same 5 checkout problems killing conversion rates.", content:[{heading:"Fix 1: Kill forced account creation",body:"Requiring account creation before checkout kills 35% of buyers. Enable guest checkout immediately."},{heading:"Fix 2: Move your CTA above the fold",body:"60% of product pages have Add to Cart below the fold on mobile. Your price and CTA must be visible without scrolling."},{heading:"Fix 3: Fix your mobile speed",body:"If your page loads in over 3 seconds on mobile, you lose 40% of visitors before they see your product."}] },
  { id:"tiktok-vs-meta-2025", title:"TikTok vs Meta Ads in 2025: Where Should Your Budget Go?", category:"Ad Strategy", date:"March 10, 2025", readTime:"7 min read", excerpt:"The answer isn't one or the other. Build a strategy that uses both at the right time.", content:[{heading:"Meta: Still the conversion king",body:"Meta has 10+ years of purchase behaviour data. For retargeting and scaling proven winners, nothing beats it."},{heading:"TikTok: The discovery engine",body:"TikTok finds audiences you didn't know existed. Raw, authentic content wins. Polished ads die."},{heading:"Our recommendation",body:"70% Meta, 30% TikTok. Use TikTok to find audiences, Meta to convert them."}] },
  { id:"email-flows-that-print-money", title:"The 3 Email Flows Every E-commerce Store Needs", category:"Email Marketing", date:"February 22, 2025", readTime:"9 min read", excerpt:"Email generates $42 for every $1 spent. Most stores leave 30% of revenue on the table.", content:[{heading:"Flow 1: Abandoned Cart",body:"A 3-email sequence recovers 15-20% of abandoned carts. Email 1: reminder. Email 2: address objections. Email 3: 10% off with urgency."},{heading:"Flow 2: Post-Purchase",body:"Confirm the order, set delivery expectations, offer a complementary product, and ask for a review 7 days later."},{heading:"Flow 3: Win-Back",body:"A 2-email sequence reactivates 8-12% of customers who haven't bought in 90 days."}] },
];
...
/* ── VIDEO TIPS — fixed duplicate, added correct Store Audit video ── */
export const VIDEO_TIPS = [
  {
    tag:"Checkout Tip",
    title:"Why your checkout loses 40% of buyers",
    desc:"The #1 mistake e-commerce stores make that kills conversions.",
    videoId:"HcNzgUUQI5g",
  ...
  },
  {
    ...
    desc:"A simple audience restructure most agencies overlook.",
    videoId:"SklDEDMQmmY",
    thumb:"https://i.ytimg.com/vi/SklDEDMQmmY/hqdefault.jpg",
  },
  {
    /* ✅ REPLACED — was duplicate "UQGUkS8H-44", now correct Store Audit short */
    tag:"Store Audit",
    title:"5 things we check in every store audit",
    desc:"The exact checklist we use to find where your store leaks money.",
    videoId:"vxmXlxLjDRY",
    thumb:"https://i.ytimg.com/vi/vxmXlxLjDRY/hqdefault.jpg",
  },
  {
    tag:"ROAS Explained",
    title:"What a 4x ROAS actually looks like",
    desc:"Real numbers, breaking down what makes ads profitable.",
    videoId:"UQGUkS8H-44",
  ...
  },
  {
    ...
    desc:"3 emails, exact timing, exact copy. Free to implement today.",
    videoId:"fvbex4WkncE",
