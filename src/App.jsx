    ...
    <div
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        body { overflow-x:hidden; background:${dark?"#040608":"#F5C518"} !important; }
        ...
        .btn-ghost:hover{background:${dark?"rgba(255,255,255,.1)":"rgba(26,20,8,.14)"};border-color:rgba(0,255,136,.4);color:${dark?"#fff":"#1A1408"};transform:translateY(-2px);}

        /* ── DIVIDER ── */
        .divider{border:none;border-top:.5px solid ${dark?"rgba(255,255,255,.06)":"rgba(26,20,8,.2)"};}

        /* ── GLASS CARDS ── */
        .glass{
          background:${dark?"linear-gradient(135deg,rgba(255,255,255,.07),rgba(255,255,255,.02))":"linear-gradient(135deg,rgba(255,255,255,.45),rgba(255,255,255,.2))"};
          border:.5px solid ${dark?"rgba(255,255,255,.12)":"rgba(26,20,8,.18)"};
          border-top:.5px solid ${dark?"rgba(255,255,255,.22)":"rgba(255,255,255,.7)"};
          border-radius:16px;position:relative;overflow:hidden;
          transition:transform .5s cubic-bezier(.22,1,.36,1),box-shadow .5s,border-color .3s;
        }
        .glass::before{content:'';position:absolute;top:0;left:10%;right:10%;height:1px;background:${dark?"linear-gradient(90deg,transparent,rgba(255,255,255,.28),transparent)":"linear-gradient(90deg,transparent,rgba(255,255,255,.8),transparent)"};}
        ...
        /* ── STAT CARDS ── */
        .stat-card{
          background:${dark?"rgba(255,255,255,.04)":"rgba(255,255,255,.35)"};
        ...
        /* ── OFFER CARDS ── */
        .offer-card{
          background:${dark?"linear-gradient(135deg,rgba(255,255,255,.05),rgba(255,255,255,.02))":"linear-gradient(135deg,rgba(255,255,255,.45),rgba(255,255,255,.2))"};
