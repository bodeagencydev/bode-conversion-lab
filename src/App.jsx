...
function AppInner({ dark }) {
  ...
  // Replaced #F5C518 with the updated vibrant light background
  const bg = dark ? "#040608" : "#e5a90a"; 
  const fg = dark ? "#f0f0f0" : "#120d02";
    ...
    <div
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        body { overflow-x:hidden; background:${dark ? "#040608" : "#e5a90a"} !important; }
        ...
        @keyframes glowPulse{0%,100%{box-shadow:0 0 18px rgba(0,255,136,.25),0 4px 22px rgba(0,255,136,.3);}50%{box-shadow:0 0 40px rgba(0,255,136,.6),0 8px 40px rgba(0,255,136,.5);}}
        @keyframes mobilePulse{0%,100%{box-shadow:0 0 14px rgba(0,255,136,.4);}50%{box-shadow:0 0 28px rgba(0,255,136,.7);}}
        ...
        @keyframes glow{0%,100%{box-shadow:0 0 18px rgba(0,255,136,.35);}50%{box-shadow:0 0 42px rgba(0,255,136,.7);}}
        ...
        .btn-g{
          ...
          box-shadow:0 4px 22px rgba(0,255,136,.45);
        ...
        .btn-g:hover{transform:translateY(-3px) scale(1.03);box-shadow:0 14px 44px rgba(0,255,136,.85);}
        .btn-g:hover::after{left:140%;}
        @media(hover:hover){.btn-g{animation:glowPulse 3s ease-in-out infinite;}}
        .btn-g:hover{animation:none;}

        .btn-ghost{
          background:${dark ? "rgba(255,255,255,.06)" : "rgba(18,13,2,.08)"};
          color:${dark ? "rgba(255,255,255,.7)" : "rgba(18,13,2,.85)"};
          border:.5px solid ${dark ? "rgba(255,255,255,.15)" : "rgba(18,13,2,.25)"};
        ...
        .btn-ghost:hover{background:${dark ? "rgba(255,255,255,.1)" : "rgba(18,13,2,.14)"};border-color:rgba(0,255,136,.6);color:${dark ? "#fff" : "#120d02"};transform:translateY(-2px);}

        /* ── DIVIDER ── */
        .divider{border:none;border-top:.5px solid ${dark ? "rgba(255,255,255,.06)" : "rgba(18,13,2,.2)"};}

        /* ── GLASS CARDS ── */
        .glass{
          background:${dark ? "linear-gradient(135deg,rgba(255,255,255,.07),rgba(255,255,255,.02))" : "linear-gradient(135deg,rgba(255,255,255,.55),rgba(255,255,255,.25))"};
          border:.5px solid ${dark ? "rgba(255,255,255,.12)" : "rgba(18,13,2,.2)"};
          border-top:.5px solid ${dark ? "rgba(255,255,255,.22)" : "rgba(255,255,255,.8)"};
          border-radius:16px;position:relative;overflow:hidden;
          transition:transform .5s cubic-bezier(.22,1,.36,1),box-shadow .5s,border-color .3s;
        }
        .glass::before{content:'';position:absolute;top:0;left:10%;right:10%;height:1px;background:${dark ? "linear-gradient(90deg,transparent,rgba(255,255,255,.28),transparent)" : "linear-gradient(90deg,transparent,rgba(255,255,255,.9),transparent)"};}
        .glass:hover{transform:translateY(-6px) scale(1.01);box-shadow:0 24px 56px rgba(0,255,136,.2),0 4px 16px rgba(0,0,0,.1);border-color:rgba(0,255,136,.45)!important;}

        /* ── STAT CARDS ── */
        .stat-card{
          background:${dark ? "rgba(255,255,255,.04)" : "rgba(255,255,255,.45)"};
          border:.5px solid ${dark ? "rgba(255,255,255,.08)" : "rgba(18,13,2,.18)"};
        ...
        /* ── OFFER CARDS ── */
        .offer-card{
          background:${dark ? "linear-gradient(135deg,rgba(255,255,255,.05),rgba(255,255,255,.02))" : "linear-gradient(135deg,rgba(255,255,255,.55),rgba(255,255,255,.25))"};
          border:.5px solid ${dark ? "rgba(255,255,255,.1)" : "rgba(18,13,2,.2)"};
        ...
        .offer-card.feat{border-color:rgba(0,255,136,.6)!important;background:linear-gradient(135deg,rgba(0,255,136,.12),rgba(0,204,106,.05))!important;animation:glowPulse 3s ease-in-out infinite;}
        .offer-card.feat:hover{animation:none;}

        /* ── PARTNER CARDS ── */
        .partner-card{
          background:${dark ? "rgba(255,255,255,.04)" : "rgba(255,255,255,.45)"};
          border:.5px solid ${dark ? "rgba(255,255,255,.1)" : "rgba(18,13,2,.18)"};
        ...
        .partner-card:hover{background:rgba(0,255,136,.1)!important;border-color:rgba(0,255,136,.6)!important;transform:translateY(-5px) scale(1.02);box-shadow:0 14px 36px rgba(0,255,136,.25);animation:none;}

        /* ── CARD 3D ── */
        .card3d{transition:transform .5s cubic-bezier(.22,1,.36,1),box-shadow .5s;}
        .card3d:hover{transform:perspective(900px) rotateY(6deg) rotateX(-4deg) scale(1.03);box-shadow:0 24px 64px rgba(0,0,0,.25),0 0 0 1px rgba(0,255,136,.3);}
