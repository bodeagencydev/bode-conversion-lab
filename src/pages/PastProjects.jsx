...
const GALLERY = [
  ...
  { type: "video", src: "", videoSrc: "/proof/Videoproof1.mp4", label: "Stream Ride Store", tag: "$36k sales", color: "#00ff88" },
  ...
  { type: "video", src: "", videoSrc: "/proof/Videoproof3.mp4", label: "Bomia Brand", tag: "$0-$4k sales", color: "#4285F4" },
  { type: "video", src: "", videoSrc: "/proof/Videoproof12.mp4", label: "SassyL", tag: "Customer Winback Flow Built", color: "#B48CFF" },
  { type: "video", src: "", videoSrc: "/proof/Videoproof2.mp4", label: "Novi Good store", tag: "4.3x ROAS-$57k sales", color: "#0081FB" },
  ...
  { type: "video", src: "", videoSrc: "/proof/Videoproof5.mp4", label: "Robin and Roobaby store", tag: "$77k sales", color: "#00ff88" },
  { type: "video", src: "", videoSrc: "/proof/Videoproof10.mp4", label: "Glitch & Grin",   tag: "100% SEO Score",                 color: "#34D399" },
  { type: "video", src: "", videoSrc: "/proof/Videoproof4.mp4", label: "Bomia Brand Store 2", tag: "Roas 2x", color: "#FFD700" },
  ...
  { type: "video", src: "", videoSrc: "/proof/Videoproof6.mp4", label: "Vista Market Online Store", tag: "$41k sales", color: "#ffffff" },
];
