      ...
      <div style={{ minHeight:"80vh", display:"flex", alignItems:"center", justifyContent:"center", padding:"2rem" }}>
        <div style={{ maxWidth:380, width:"100%", background:cardBg, border:`.5px solid ${cardBorder}`, borderTop:".5px solid rgba(0,255,136,.3)", borderRadius:24, padding:"2.5rem", position:"relative", overflow:"hidden" }}>
          ...
          <div style={{ textAlign:"center", marginBottom:"2rem" }}>
            ...
            <h2 style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:"1.4rem", fontWeight:800, color:headingColor }}>Admin Panel</h2>
    ...
    <PageWrapper>
      <div style={{ maxWidth:1100, margin:"0 auto", padding:"clamp(2rem,5vw,4rem) clamp(1rem,4vw,2rem) 6rem" }}>
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"2rem", flexWrap:"wrap", gap:"1rem" }}>
          <div>
            <h1 style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:"clamp(1.5rem,4vw,2rem)", fontWeight:800, color:headingColor, marginBottom:".2rem" }}>
              Admin Panel
            </h1>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:"0.75rem", marginBottom:"2rem" }}>
          {[
            ...
            <div key={i} style={{ background:cardBg, border:`.5px solid ${cardBorder}`, borderRadius:14, padding:"1.2rem", textAlign:"center" }}>
              <p style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:"1.8rem", fontWeight:800, color:s.color, margin:0 }}>{s.value}</p>
        ...
        <div style={{ background:cardBg, border:`.5px solid ${cardBorder}`, borderTop:".5px solid rgba(0,255,136,.25)", borderRadius:20, padding:"1.8rem", marginBottom:"2rem", position:"relative", overflow:"hidden" }}>
          ...
          <h3 style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:"1rem", fontWeight:800, color:headingColor, marginBottom:"1.2rem" }}>
                  ...
                  <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:"1rem", flexWrap:"wrap" }}>
                    ...
                    <div style={{ flex:1, minWidth:180 }}>
                      <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:".3rem", flexWrap:"wrap" }}>
                        <p style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:14, fontWeight:800, color:entry.active?headingColor:"rgba(255,59,59,.7)", margin:0 }}>{entry.clientName}</p>
                    ...
                    <div style={{ display:"flex", flexDirection:"column", gap:6, alignItems:"flex-end" }}>
                      ...
                      <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                        <span style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:"1rem", fontWeight:800, color:entry.active?G:"rgba(255,59,59,.7)", letterSpacing:".08em" }}>{entry.code}</span>
