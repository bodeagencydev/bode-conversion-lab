...
const s = StyleSheet.create({
  ...
  h1: { fontFamily:"Space Grotesk", fontSize: 30, fontWeight: 800, color: INK, lineHeight: 1.12, marginBottom: 10 },
  ...
  sectionTitle: { fontFamily:"Space Grotesk", fontSize: 15, fontWeight: 800, color: INK, marginTop: 18, marginBottom: 8 },
  ...
  coverStatNum: { fontFamily:"Space Grotesk", fontSize: 30, fontWeight: 800, color: GREEN },
