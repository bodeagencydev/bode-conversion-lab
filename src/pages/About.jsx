...
import { Section, SectionLabel, Heading, GradText, SvgGradText, PageWrapper, useTheme, SEO, HeroBackdrop } from "../components.jsx"; 
          ...
          <div className="how-grid" style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"1rem" }}>
            {[
              ...
              <div key={i} className="glass card3d" style={{ padding:"2rem" }}>
                <SvgGradText colors={[glow(.55), glow(.15)]} fontFamily="'Space Grotesk',sans-serif" fontSize="1.2rem" fontWeight={800} style={{ marginBottom:".75rem" }}>{v.icon}</SvgGradText>
