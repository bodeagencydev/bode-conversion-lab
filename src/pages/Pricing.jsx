  ...
  const tiers = [
    {
      ...
      items: [
        "Full technical + trust-signal audit — speed, SEO, checkout, policies, social proof",
        "Checkout & conversion friction mapping",
        "Ad account health check",
        "Your complete Fixing + Growth + Marketing roadmap, in priority order",
        "1 x 45-min debrief call to walk through it together",
      ],
      feat: false,
      cta: "Get started →",
    },
    {
      ...
      items: [
        ...
        "Phase 1 critical fixes implemented — the issues actively costing you sales today",
        "Phase 2 high-impact fixes — mobile speed, checkout flow, above-fold CTA",
        "Trust-signal fixes — policy pages, social proof setup",
    ...
    },
    {
      ...
      items: [
        ...
        "Meta & TikTok ad management — full TOF/MOF/BOF funnel structure",
        "Platform-specific creative strategy & copy",
        "Conversion compounding — abandoned cart recovery, post-purchase upsells, bundle strategy",
        "Ongoing CRO — A/B testing, performance monitoring",
        "Weekly performance reports (CAC, LTV, MER tracked)",
    ...
    },
    {
      ...
      items: [
        ...
        "Full email flow build (Klaviyo) — abandoned cart, post-purchase, welcome, win-back",
        "Brand positioning & content pillar strategy",
        "Creative production & UGC direction",
        "Subscription & referral program setup",
        "Weekly strategy calls, dedicated growth strategist, 2hr priority response",
      ],
      feat: false,
      cta: "Apply now →",
    },
