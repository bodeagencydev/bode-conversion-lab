  ...
  const tiers = [
    {
      ...
      desc: "For store owners who aren't sure what's actually broken yet. We go through your store, your funnel, and your ad account, then hand you a clear, prioritized list of what to fix first.",
      items: [
        "A full audit of your site's speed, SEO, checkout, policies, and trust signals",
        "A map of exactly where customers are getting stuck before they buy",
        "A health check on your ad account, so you know if it's even set up to convert",
        "A complete roadmap covering fixes, growth, and marketing, in the order that actually matters",
        "A 45-minute call to walk through it together, if you want one",
      ],
      feat: false,
      cta: "Get started →",
    },
    {
      ...
      desc: "For stores that already know they're leaking money and just want it handled. We take the highest-impact fixes from your audit and implement them ourselves within 7 days.",
      items: [
        "Everything from the Store Diagnosis",
        "The critical fixes that are actively costing you sales right now",
        "The next-tier fixes too: mobile speed, checkout flow, your above-the-fold call to action",
        "Trust-signal fixes done for you, policy pages and social proof included",
        "A 60-minute strategy call to walk through what changed",
      ],
      feat: false,
      cta: "Get started →",
    },
    {
      ...
      desc: "For stores ready to stop patching problems and start scaling. We run your ads, keep optimizing your store, and report back every week so you always know what's working.",
      items: [
        "Everything from Conversion Fix",
    ...
    },
    {
      ...
      items: [
        ...
        "A complete email flow set up in Klaviyo: welcome, abandoned cart, post-purchase, win-back",
        "Brand positioning and a content strategy you can actually follow",
        "Creative production and UGC direction",
        "Subscription and referral program setup",
        "Weekly strategy calls with a dedicated growth strategist, 2-hour priority response",
      ],
      feat: false,
      cta: "Apply now →",
    },
    ...
    <PageWrapper>
      ...
      <section style={{ position:"relative", padding:"6rem 2rem 4rem", overflow:"hidden" }}>
        <div style={{ maxWidth:700, margin:"0 auto", textAlign:"center", position:"relative", zIndex:1 }}>
          ...
          <p style={{ fontSize:"1.05rem", color:mutedText, lineHeight:1.75, marginBottom:"2rem" }}>
          ...
          {/* TERMS TICKET — signature element, echoes a receipt/invoice line */}
          <div style={{
                ...
                {tiers.map((o, i) => (
                  <div key={i} className={`offer-card ${o.feat ? "feat" : ""}`} style={{ display:"flex", flexDirection:"column" }}>
                    ...
                    <div style={{ marginBottom:"1.5rem", paddingBottom:"1.2rem", borderBottom:`.5px solid ${itemBorder}` }}>
                      <span style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize:"2rem", fontWeight:800, color:headingColor }}>${o.price}</span>
