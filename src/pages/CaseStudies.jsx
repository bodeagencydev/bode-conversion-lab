    ...
    <PageWrapper>
      ...
      <section style={{ position: "relative", padding: "7rem 2rem 5rem", overflow: "hidden" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          {/* CASE FILE INDEX — signature element, honest to the actual case count */}
          <div style={{ display:"flex", justifyContent:"center", flexWrap:"wrap", gap:10 }}>
            {CASE_STUDIES.map((c, i) => (
              <span key={c.id} style={{
                ...
                <span style={{ color:G }}>CASE_{String(i+1).padStart(2,"0")}</span>
            ...
            <ScrollReveal key={cs.id} delay={index * 0.05}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem,5vw,4rem)", alignItems: "flex-start" }} className="about-grid">
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: "1.5rem" }}>
                    {[cs.result1, cs.result2, cs.result3].map((r, i) => r && (
                      <div key={i} style={{ background: dark ? "rgba(255,255,255,.04)" : "rgba(26,20,8,.04)", border: dark ? ".5px solid rgba(255,255,255,.08)" : ".5px solid rgba(26,20,8,.1)", borderRadius: 12, padding: "1rem .75rem", textAlign: "center" }}>
                        ...
                        <p style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize: "clamp(.85rem,2vw,1.05rem)", fontWeight: 800, background: GG, WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text", margin: 0 }}>{r.after}</p>
                ...
                <div>
                  ...
                  <h2 style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize: "clamp(1.4rem,3vw,2rem)", fontWeight: 800, color: headingColor, lineHeight: 1.2, marginBottom: "1rem" }}>{cs.headline}</h2>
  ...
  return (
    <PageWrapper>
      ...
      <section style={{ padding: "7rem 2rem 4rem", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily:"'Space Grotesk',sans-serif", color: headingColor, marginTop: "1rem" }}>{cs.headline}</h1>
      </section>
      <Section>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem", marginTop: "3rem" }}>
            {cs.story && cs.story.map((s, i) => (
              <div key={i} style={{ borderLeft: `2px solid rgba(0,255,136,.3)`, paddingLeft: "1.5rem" }}>
                <h2 style={{ fontFamily:"'Space Grotesk',sans-serif", fontSize: "1.2rem", color: headingColor, marginBottom: ".75rem" }}>{s.heading}</h2>
