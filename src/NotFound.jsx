...
/* Import ThemeContext directly — avoids the useTheme export issue */
import { ThemeContext, GradText } from "./components.jsx";
import { ScrollReveal, Magnetic } from "./AnimationSystem.jsx";
  ...
  return (
    <div style={{
      ...
      <ScrollReveal delay={0.2}>
        <div style={{
          background: cardBg,
          border: ".5px solid rgba(0,255,136,.2)",
          ...
          <span style={{
            ...
            background: "rgba(0,255,136,.1)", border: ".5px solid rgba(0,255,136,.28)",
            borderRadius: 100, padding: "4px 12px", fontSize: 11, color: G,
            fontWeight: 600, marginBottom: "1rem", letterSpacing: ".06em",
          }}>
          ...
          <h1 style={{
            ...
            Page missing — but your <GradText>revenue leaks aren't.</GradText>
          </h1>
            ...
            {QUICK_LINKS.map(l => (
              <Link key={l.path} to={l.path}
                style={{
                  ...
                  padding: "10px 14px",
                  background: linkBg,
                  border: `.5px solid ${linkBorder}`,
                  borderRadius: 12, textDecoration: "none",
                  transition: "all .3s cubic-bezier(.22,1,.36,1)", minHeight: 48,
                }}
                onMouseEnter={e => {
                  e.currentTarget.style.background = "rgba(0,255,136,.07)";
                  e.currentTarget.style.borderColor = "rgba(0,255,136,.3)";
                  e.currentTarget.style.transform = "translateX(4px)";
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.background = linkBg;
                  e.currentTarget.style.borderColor = linkBorder;
